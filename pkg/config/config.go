...
func Get() *Config {
	...
	flag.StringVar(&conf.dbPass, "dbpswd", os.Getenv("POSTGRES_PASSWORD"), "DB pass")
	...
	flag.StringVar(&conf.migrate, "migrate", "up", "specify we should be migrating DB 'up' or 'down'")
